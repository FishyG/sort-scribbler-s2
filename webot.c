...
int main(int argc, char **argv) {
	...
	double avg_speed = 0;                   // Average speed
	double left_speed = 1.0;                // Speed of the left motor
	double right_speed = 1.0;               // Speed of the right motor
	double fs_values[2];                    // Array of values of the floor sensors
	double ds_values[2];                    // Array of values of the distance sensors
	double ls_values[3];                    // Array of values of the light sensors
	double ls_max = 0;
	...
	*/
	while (wb_robot_step(TIME_STEP) != -1) {
		...
		else 
		{
            ...
            printf("Light Sensor with more light = %d value: %f\n", light_index, ls_values[light_index]);
		...
		else
		{
			...
			printf("Right LED = Backward Mode\n");
		}
